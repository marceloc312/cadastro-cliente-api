...
namespace Api.Core.TestsUnidade
{
    ...
    public class AlterarEnderecoClienteTest
    {
        ...
        [InlineData(1,1, "Rua 3", "456", "", "São Paulo", "Brasil", "00998-988")]
        public async void DeveAlterarOEnderecoDoClienteComSucesso(int id,long idCliente, string logradouro, string numero, string complemento, string cidade, string pais, string cep)
        {
            // Arrange
            ...
            EnderecoCliente enderecoCliente = new EnderecoCliente(id, idCliente, logradouro, numero, complemento, cidade, pais, cep);
        ...
        [InlineData(1, 1, "Rua 3", "456", "", null, "Brasil", "00998-988")]
        [InlineData(0, 1, "Rua 3", "456", "", null, "Brasil", "00998-988")]
        public async void NaoDeveAlterarDadosInformadosInvalidos(int id, long idCliente, string logradouro, string numero, string complemento, string cidade, string pais, string cep)
        {
            // Arrange
            var enderecoClienteRepository = new Mock<IEnderecoClienteRepository>();
            enderecoClienteRepository.Setup(x => x.AlterarAsync(It.IsAny<EnderecoCliente>()));
        ...
        [InlineData(1, 1, "Rua 3", "456", "", "São Paulo", "Brasil", "00998-988")]
        public async void FalhaNaTransacaoComOBanco(int id, long idCliente, string logradouro, string numero, string complemento, string cidade, string pais, string cep)
        {
            // Arrange
            var enderecoClienteRepository = new Mock<IEnderecoClienteRepository>();
